                        ...
                        int32_t event_id, void *event_data)
{
    ...
    constexpr int8_t EXAMPLE_ESP_MAXIMUM_RETRY = 20;
...
bool WiFi_Functions::connect_to_ap(AP_Credentials *connection)
{
    ...
    if (bits & WIFI_CONNECTED_BIT)
    {
        ...
        WiFi_Functions::latestAPConnection = connection;
...
void WiFi_Functions::wifi_fail_bit_listener()
{
    ...
    while (1)
    {
        ...
        while (tries < 10)
        {
            ...
            std::cout << "\n\n\ntry number:<< " << tries << "\n\n\n";
            std::cout << "1\n";
            availability = WiFi_Functions::check_network_availability(WiFi_Functions::latestAPConnection->getWifi_ssid());
            ...
            if (availability == 2)
            {
                ...
                std::cout << "Unexpected Error while testing for availability of " << WiFi_Functions::latestAPConnection->getWifi_ssid() << "\nNext try in 5 secs.\n";
            ...
            else if (availability == 0)
            {
                ...
                std::cout << WiFi_Functions::latestAPConnection->getWifi_ssid() << " is currently not available.\nNext try in 30 secs.\n";
            ...
            else
            {
                ...
                {
                    std::cout << WiFi_Functions::latestAPConnection->getWifi_ssid() << " did not accept connection request.\nNext try in 30 secs.\n";
                    vTaskDelay(30000 / portTICK_PERIOD_MS);
                }
                else
                {
...
static void WiFi_Functions::listAllConnections()
{
    int i = 0;
    for (auto it : vec_AP_Credentials)
    {
...
void WiFi_Functions::printConnectionData()
{
