...
#define CONFIG_SPI_MOSI GPIO_NUM_23
#define CONFIG_SPI_MISO GPIO_NUM_19
#define CONFIG_SPI_CLOCK GPIO_NUM_18
#define CONFIG_TFT_CS_PIN GPIO_NUM_15
#define CONFIG_TFT_DC_PIN GPIO_NUM_2
// #define CONFIG_DISPLAY_COLOR_MODE GPIO_NUM_
#define CONFIG_TFT_RESET_PIN GPIO_NUM_4
...
//     lv_disp_draw_buf_init(&disp_buf,buf_1,NULL,480*10);
...
//     display_drv.hor_res = (480);
//     display_drv.ver_res = (320);
//     display_drv.flush_cb = ili9488_flush;
//     display_drv.draw_buf = &disp_buf;

//     static const lv_area_t area = {100,100,140,140};
//     static lv_color_t color = lv_color_make(255,0,0);
...
//     ili9488_flush(&display_drv, &area , &color);
